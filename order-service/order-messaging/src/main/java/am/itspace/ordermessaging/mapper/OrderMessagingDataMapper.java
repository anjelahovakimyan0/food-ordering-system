package am.itspace.ordermessaging.mapper;

import am.itspace.kafkamodel.kafka.order.avro.model.*;
...
public class OrderMessagingDataMapper {
    ...
    orderPaidEventToRestaurantApprovalRequestAvroModel(OrderPaidEvent orderPaidEvent) {
        ...
        return RestaurantApprovalRequestAvroModel.newBuilder()
                .setId(UUID.randomUUID())
                .setSagaId(UUID.randomUUID())//TODO
                .setOrderId(order.getId().getValue())
                .setRestaurantId(order.getRestaurantId().getValue())
                .setOrderId(order.getId().getValue())
                .setRestaurantOrderStatus(am.itspace.kafkamodel.kafka.order.avro.model.RestaurantOrderStatus
                        .valueOf(order.getOrderStatus().name()))
                .setProducts(order.getItems().stream().map(orderItem ->
                        am.itspace.kafkamodel.kafka.order.avro.model.Product.newBuilder()
    ...
    public PaymentResponse paymentResponseAvroModelToPaymentResponse(PaymentResponseAvroModel
        ...
        return PaymentResponse.builder()
                ...
                .paymentStatus(am.itspace.commondomain.entity.valueObject.PaymentStatus.valueOf(
    ...
    approvalResponseAvroModelToApprovalResponse(RestaurantApprovalResponseAvroModel
        ...
        return RestaurantApprovalResponse.builder()
                ...
                .orderApprovalStatus(am.itspace.commondomain.entity.valueObject.OrderApprovalStatus.valueOf(
